...
def read_labelmap(labelmap_file):   #ava_action_list_v2.2_for_activitynet_2019.pbtxt
...
def parse_arguments():
  ...
  parser.add_argument(
      ...
      default='/data/video_caption_database/ava/ava/preproc_train/' + EvalConfig.PATH_TO_ACTION_LIST)
  parser.add_argument(
      "-g",
      "--groundtruth",
      help="CSV file containing ground truth.",
      type=argparse.FileType("r"),
      default='/home/ganhaiyang/output/ava/'+EvalConfig.PATH_TO_LABLE,
      # default= EvalConfig.PATH_TO_LABLE,
      required=False)
  ...
  parser.add_argument(
      ...
      # default='/home/ganhaiyang/output/ava/' + EvalConfig.PATH_TO_RESULTS,
      required=False)
  parser.add_argument(
      "-e",
      "--exclusions",
      help=("Optional CSV file containing videoid,timestamp pairs to exclude "
            "from evaluation."),
      type=argparse.FileType("r"),
      default='/home/ganhaiyang/output/ava/' + EvalConfig.PATH_TO_EXCLUSIONS,
      required=False)
